...
func _ready():
	...
	match columna:
		0:
			...
			textura = preload("res://texturas/textura_ladrillos.jpg")
		1:
	...
	mat_variante.normal_enabled = true
	mat_variante.normal_texture = preload("res://texturas/mapa_normales_ladrillos.jpg")
	mat_variante.normal_texture = preload("res://texturas/textura_piedras.jpg")
...
func _toggle_textura():
	...
	if mostrar_textura:
		print("Mostrando solo textura (sin color)")
		mat_variante.albedo_texture = textura
		mat_variante.albedo_color = Color(1, 1, 1, 1)
	else:
		print("Mostrando solo color (sin textura)")
		mat_variante.albedo_texture = null
		mat_variante.albedo_color = base_color
